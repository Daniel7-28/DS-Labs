...
public class Lab09P3Wrapper {
	...
	public static class BinaryTree<E> implements Tree<E> {
		...
		public int height(E e) {
			...
			return heightAux(node, e);
		}	

		private int heightAux(BinaryTreeNode<E> root,E e) {
			int height = 0;
			if(root == null)
				return -1;

			int leftHeight = heightAux(root.getLeftChild(), e);
			int rightHeight = heightAux(root.getRightChild(),e);
